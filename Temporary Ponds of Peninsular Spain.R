...
# The TemPondS dataset is available in 
# Digital-CSIC:
# Zenodo: 
# GitHub: https://github.com/christianarnanz/TemPondS
...
attrs_natura <- joined_natura %>%
  ...
  summarise(
    ...
    N2K_site_designation = case_when(
      ...
      natura2000_tipo == "A" ~ "SPAs",
      natura2000_tipo == "B" ~ "SAC/SCI",
      natura2000_tipo == "C" ~ "SAC/SCI & SPAs",
      natura2000_tipo %in% c("A;B", "B;A", "A; B", "B; A") ~ "SAC/SCI & SPAs",
